...
const GetStarted = ({ updateData }) => {
  ...
  const selectPlanAndSignup = (plan) => {
    updateData({ amountToCharge: plan.price, chargedEvery: plan.chargeOn, plan: plan.name })
    navigate('/signUp');
  };
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Button sx={{
              ...
              onClick={() => selectPlanAndSignup({ 'name': 'free-trial', 'price': 0, chargeOn: 7 })}
            >
              Start Free Trial
            </Button>
          </Box>
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Button sx={{
              ...
              onClick={() => selectPlanAndSignup({ 'name': 'starter', 'price': monthly === true ? 70 : 63, 'chargeOn': monthly === true ? 'monthly' : 'yearly' })}
            >
              Get Started
            </Button>
          </Box>
          ...
          <Box sx={{
            ...
            <Box sx={{
              ...
              <Button sx={{
                ...
                onClick={() => selectPlanAndSignup({ 'name': 'growth', 'price': monthly === true ? 120 : 102, 'chargeOn': monthly === true ? 'monthly' : 'yearly' })}
              >
                Get Started
              </Button>
            </Box>
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Button sx={{
              ...
              onClick={() => selectPlanAndSignup({ 'name': 'accelerator', 'price': monthly === true ? 200 : 170, 'chargeOn': monthly === true ? 'monthly' : 'yearly' })}
            >
              Get Started
            </Button>
          </Box>
